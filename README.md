...
Odpowiedź:  Po włączeniu symulacji Dioda L zaświeca sie.. 

## Zadanie 2-2-2:
Pytanie:    *Czy zamienienie kolejności podłączenia diody LED i rezystora ma znaczenie?*  
Odpowiedź:  Brak znaczenia. Byle szeregowo.

## Zadanie 2-2-3:
Pytanie:    *Czy każdy rodzaj pętli jest wymienny (zawsze można zastąpić jedną konstrukcję drugą)?*  
Odpowiedź:  Przy odpowiednim skonstruowaniu możliwe jest zamienienie pod warunkiem ostatecznej zgodności z warunkami zadania. Czyli jest to możliwe ale nie zawsze. 

## Zadanie 2-2-4:
Pytanie:    *Jak wpływa na działanie układu zwiększenie wartości stałej LED_T (np. do 100 ms)?*  
Odpowiedź:  Przyspieszenie działania..

## Zadanie 2-3-1:
Pytanie:    *Jakie niedogodności z punktu widzenia kierowców są obecne w programie sterującym światłami?*  
Odpowiedź:  Naciśnięcie przycisku na sygnalizacji świetlnej dla pieszych powoduje zbyt szybką zmianę dla sygnalizacji świetlnej pojazdów.
